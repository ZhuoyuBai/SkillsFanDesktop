 ...
 *
 * Provides skillsfan-file:// protocol to bypass cross-origin restrictions when loading
 * local files from localhost (dev mode) or app:// (production mode).
 *
 * Usage:
 * - Images: <img src="skillsfan-file:///path/to/image.png">
 * - PDF: BrowserView.loadURL("skillsfan-file:///path/to/doc.pdf")
