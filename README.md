...
说实话，我自己也没有编程经验。但正因如此，我才更理解那些被终端挡在门外的人的感受。

于是我用 AI Agent 本身，从零开始构建了 SkillsFan 的第一版。之后的每一个功能，也都是用 SkillsFan 自己开发的。SkillsFan 的存在本身就是最好的证明 —— 即使不会编程，AI Agent 也能帮你创造出真正可用的产品。

但一个人的力量终究有限。我不是专业开发者，很多技术决策和优化超出了我的能力范围。所以我选择把 SkillsFan 开源 —— 不是因为它已经完美，而是因为我相信，当更多有热情的开发者加入进来，它会变得比我一个人能做到的好得多。

如果你对 AI Agent 感兴趣，欢迎加入我们，一起让更多人用上 AI 的力量。
